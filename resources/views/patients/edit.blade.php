                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('patients.update', $patient->id) }}" method="POST">
                                    ...
                                    <select name="site_id" class="form-select" id="floatingSelect" aria-label="State">
                                        ...
                                        @foreach ($sites as $site)
                                            <option value="{{ $site->id }}"
                                                {{ $patient->site_id == $site->id ? 'selected' : '' }}>
                                                {{ $site->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="rekam_medis" value="{{ $patient->rekam_medis }}" class="form-control" id="rekam_medis">
                                @error('rekam_medis')
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="name" value="{{ $patient->name }}" class="form-control" id="name">
                                @error('name')
                                    <div class="text-danger"><small>{{ $message }}</small></div>
                                @enderror
                            </div>
                            <div class="col-12">
                                ...
                                <input type="date" name="dob" value="{{ $patient->dob }}" class="form-control" id="dob">
                                @error('dob')
                                    <div class="text-danger"><small>{{ $message }}</small></div>
                                @enderror
                            </div>
